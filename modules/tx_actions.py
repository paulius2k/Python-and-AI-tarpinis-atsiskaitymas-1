...
def prepare_to_list_transactions(registry: Registry, catalogue: Catalogue, client_id, txn_status = 1, top_msg = ""):
    """
    ...
    try:
        ...
        found_items = registry.get_transactions(client_id=client_id, txn_status=txn_status)        
